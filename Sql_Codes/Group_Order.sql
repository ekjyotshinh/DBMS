...
SELECT INITCAP(lname), INITCAP(fname), salary FROM candidate_shinh ORDER BY lname; 


SELECT INITCAP(lname), INITCAP(fname), salary FROM candidate_shinh ORDER BY 1 DESC, 2;


SELECT INITCAP(lname), INITCAP(fname), NVL(salary*2,0) AS Double_Salary FROM candidate_shinh ORDER BY Double_Salary DESC;